...
$buildRoot = "C:/Temp/cf_input_gate_testlib"
...
for ($i = 1; $i -le $CaseCount; $i++) {
  ...
  $maxLen = Get-Random -Minimum 5 -Maximum 12
...
$badIn = Join-Path $work "bad_name.in"
...
[System.IO.File]::WriteAllText($probeWrong, "Hello, WRONG!`n", (New-Object System.Text.UTF8Encoding($false)))
