...
$buildRoot = "C:/Temp/cf_reactor_reset_testlib"
...
for ($i = 1; $i -le $CaseCount; $i++) {
  ...
  $cmdLine = '"' + $gen + '" --low=-1000000000 --high=1000000000 --maxFactor=100000 ' + $i + ' > "' + $inFile + '"'
...
[System.IO.File]::WriteAllText($badIn, "0
0
100001
...
[System.IO.File]::WriteAllText($probeWrong, "wrong
", (New-Object System.Text.UTF8Encoding($false)))
