...
$buildRoot = "C:/Temp/cf_group01_gate_equation_testlib"
...
$badIn = Join-Path $work "bad_number_range.in"
[System.IO.File]::WriteAllText($badIn, "2000000000`n0`n0`n", (New-Object System.Text.UTF8Encoding($false)))
...
[System.IO.File]::WriteAllText($probeWrong, "0`n", (New-Object System.Text.UTF8Encoding($false)))
