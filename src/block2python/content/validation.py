...
def validate_nodes(
    ...
    for scene_id, scene in scenes.items():
        if scene.mission_statement_scene_id is not None and scene.mission_statement_scene_id not in scenes:
            raise GameContentAssemblyError(
                f"Scene {scene_id} references missing mission_statement_scene_id: {scene.mission_statement_scene_id}"
            )
