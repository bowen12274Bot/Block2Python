...
func show_demo(demo_view: Dictionary) -> void:
	...
	var body: String = str(demo_view.get("body", "This demo flow is not defined yet."))
	var demo_id: String = str(demo_view.get("demo_id", ""))
	var level_id: String = str(demo_view.get("current_level_id", ""))
	summary_label.text = "%s

demo_id: %s
level_id: %s" % [body, demo_id if demo_id != "" else "-", level_id if level_id != "" else "-"]
...
func _on_continue_button_pressed() -> void:
	status_label.text = "Status: continuing demo placeholder..."
