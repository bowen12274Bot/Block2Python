...
@onready var practice_panel = $Overlay/PracticePanel
@onready var feedback_panel = $Overlay/OutputPanel
@onready var assistant_log: RichTextLabel = $Overlay/AssistantPanel/AssistantMargin/AssistantRoot/AssistantLog
@onready var assistant_subhead_label: Label = get_node_or_null("Overlay/AssistantPanel/AssistantMargin/AssistantRoot/AssistantSubhead")
@onready var assistant_input: LineEdit = $Overlay/AssistantPanel/AssistantMargin/AssistantRoot/AssistantInput
@onready var config_row: Control = get_node_or_null("Overlay/AssistantPanel/AssistantMargin/AssistantRoot/ConfigRow")
...
@onready var api_key_visibility_button: Button = get_node_or_null("Overlay/AssistantPanel/AssistantMargin/AssistantRoot/ConfigRow/ApiKeyVisibilityButton")
...
@onready var provider_form: Control = get_node_or_null("Overlay/AssistantPanel/AssistantMargin/AssistantRoot/ConfigForm")
@onready var endpoint_input: LineEdit = get_node_or_null("Overlay/AssistantPanel/AssistantMargin/AssistantRoot/ConfigForm/EndpointInput")
@onready var model_input: LineEdit = get_node_or_null("Overlay/AssistantPanel/AssistantMargin/AssistantRoot/ConfigForm/ModelInput")
@onready var timeout_input: LineEdit = get_node_or_null("Overlay/AssistantPanel/AssistantMargin/AssistantRoot/ConfigForm/TimeoutInput")
@onready var system_prompt_input: TextEdit = get_node_or_null("Overlay/AssistantPanel/AssistantMargin/AssistantRoot/ConfigForm/SystemPromptInput")
@onready var provider_form_hint_label: Label = get_node_or_null("Overlay/AssistantPanel/AssistantMargin/AssistantRoot/ConfigForm/ProviderFormHint")
...
@onready var toolkit_hint: RichTextLabel = get_node_or_null("Overlay/ToolkitPanel/ToolkitMargin/ToolkitRoot/ToolkitHint")
...
func _ready() -> void:
	...
	if api_key_visibility_button != null:
	...
	if assistant_subhead_label != null:
...
func _refresh_tutor_controls() -> void:
	...
	if requires_provider_form and endpoint_input != null and model_input != null:
...
func _refresh_provider_form() -> void:
	...
	if save_tutor_config_button != null:
	...
	if provider == "temple":
		...
		if provider_form_hint_label != null:
