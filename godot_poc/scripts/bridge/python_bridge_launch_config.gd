...
static func build(project_resolver: Callable, python_rel_path: String, pythonpath_rel_path: String, wasm_rel_path: String, levels_rel_path: String, game_content_rel_path: String, wasmtime_candidate_rel_paths: PackedStringArray) -> Dictionary:
